...
Désiloter l'administration et ouvrir l'innovation, collaborer avec la société civile dans l'élaboration et la mise en oeuvre des politiques publiques
...
Rares sont donc les données publiques qui ne sont donc pas concernées par cette obligation d'ouverture. 
...
* la licence ODBL (OpenDataBaseLicense).
...
[![](./img/wtfopendata.png)](https://www.data.gouv.fr/fr/datasets/aife-de-33592022900036-23/)
---
...
.reduite[![](./img/repelusreuse.png)](https://mlaunois.github.io/rapport-les-elus-nationaux/rapport-rne.html#nos-maires)

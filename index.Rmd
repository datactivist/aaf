...
** Lundi 21 juin 9h30-12h30 **

* La conduite d’un projet open data et ses facteurs de succès - La place de l’archiviste dans un projet d’open data

* Les bénéfices internes et externes de l’open data

* Panorama des usages des données ouvertes

* L’enjeu de la qualité des données : exercice avec le sprint qualité de la FING (Fondation Internet Nouvelle Génération)
]
...
### S'appuyer sur le recensement pour connaître données ouvrables
...
Il y a 2 grandes familles de données dans les services d'archives :

* Les ![données d'activité du service](https://www.data.gouv.fr/fr/datasets/les-entrees-darchives-aux-archives-nationales/) (registre des entrées, indicateurs d'activité...)

* Les ![données liées aux fonds conservés](https://trouver.datasud.fr/dataset/marseille-photographies/resource/6401b5d4-28ce-467b-8cff-ffa96a1312bc) : description + images
...
* [Anonymiser](https://datascience.etalab.studio/pseudo/) des données 
...
* Le standard a été réalisé par le SIAF et l'AAF, qui a mobilisé le réseau sur le sujet

* Il va permettre de structurer les données avant de les publier sur une plateforme open data ou le site internet d'une institution
...
Des métadonnées pour éviter d'avoir un [jeu de données mal documenté](https://www.data.gouv.fr/fr/datasets/c2020-sbep-028/#_).
...
.reduite.center[![](img/matricefreinmoteur.png)]

* **Faciliter la découverte et l’utilisation des données**

["La déception en 4 actes"](https://twitter.com/JulesGrandin/status/935838409809125376)

---

### Les 10 commandements 

![](img/10commandements.png)

---

### Mais que peut-on ouvrir?

* [Les données d'activités du service](https://data.culture.gouv.fr/explore/dataset/activite-des-services-darchives-en-france/table/) 

* [Les données produites concernant les fonds](https://www.data.gouv.fr/fr/datasets/les-denaturalises-de-vichy/)

* Les données produites dans le cadre de travaux d'indexation collaborative : [Archives Municipales d'Orléans](https://archives.orleans-metropole.fr/annotation-collaborative/chercher-dans-les-annotations/actes-dengagement-militaire?arko_default_603f6a6b6d272--ficheFocus=) ou [SHD](https://www.memoiredeshommes.sga.defense.gouv.fr/fr/article.php?laref=1380&titre=telechargement)

---

### De l'open data à l'open content

* L'open content c'est **l'ouverture des contenus**

![](img/OpenContent.png)

---

### Offrir la possibilité de s'amuser

[Carte à partir des images en open data (et avec du contenu ouvert!) des Archives Municipales des Marseille](https://umap.openstreetmap.fr/fr/map/carte-des-photos-en-open-data-des-am-de-marseille_628303#13/43.2903/5.3788)

![](img/Marseille_carte.png)
...
.pull-right[
En petits groupes, analysez les [données brutes](https://docs.google.com/spreadsheets/d/1gLSCGwmuUeV2d-gbgsgyRUSuMihRvEvzOIvU9x2Nd1g/edit?usp=sharing) et synthétisez  : 
...
### Annexe méthodologique : Passage en CSV : bien plus que “enregistrer sous”
